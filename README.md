...
For release notes, see the [CHANGELOG](CHANGELOG.md). Prior to v2.4.8, release notes can be found at https://aws.amazon.com/releasenotes/JavaScript
...
HTML pages:
    ...
    <script src="https://sdk.amazonaws.com/js/aws-sdk-2.137.0.min.js"></script>
